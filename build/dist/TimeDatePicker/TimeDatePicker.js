...
const TimeDatePicker = (props) => {
    const { style, currentDate = new Date(), selectedDate, mode = Modes.date, } = props;
    ...
    return (<CalendarContext.Provider value={contextValue}>
      <View style={[_style.container, { minHeight }, style]} onLayout={({ nativeEvent }) => setMinHeight(nativeEvent.layout.width * 0.9 + 55)}>
        {renderBody()}
      </View>
...
//# sourceMappingURL=TimeDatePicker.js.map